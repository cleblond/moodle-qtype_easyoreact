...
/**
 * easyoreact question editing form definition.
 *
 * @copyright  2007 Jamie Pratt
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
...
//		$appleturl = new moodle_url('/question/type/easyoreact/easyoreact/easyoreact.jar');


		//get the html in the easyoreactlib.php to build the applet
//	    $easyoreactbuildstring = "\n<applet code=\"easyoreact.class\" name=\"easyoreact\" id=\"easyoreact\" archive =\"$appleturl\" width=\"460\" height=\"335\">" .
//	  "\n<param name=\"options\" value=\"" . $CFG->qtype_easyoreact_options . "\" />" .
//      "\n" . get_string('javaneeded', 'qtype_easyoreact', '<a href="http://www.java.com">Java.com</a>') .
//	  "\n</applet>";
...
msketch_end();
		...
		$mform->addElement('html', html_writer::link($easyoreacthomeurl, get_string('easyoreacteditor', 'qtype_easyoreact')));
		$mform->addElement('html', html_writer::empty_tag('br'));
		$mform->addElement('html', html_writer::tag('span', get_string('author', 'qtype_easyoreact'), array('class'=>'easyoreactauthor')));
...
//crl mrv		$scriptattrs = 'onClick = "getSmilesEdit(this.name, \'cxsmiles:u\')"';
        ...
        $insert_button = $mform->createElement('button','insert',get_string('insertfromeditor', 'qtype_easyoreact'),$scriptattrs);
