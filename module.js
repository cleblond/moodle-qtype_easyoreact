...
M.qtype_easyoreact = {
    insert_easyoreact_applet: function(Y, toreplaceid, appletid, appletname,
        topnode, appleturl, feedback, readonly, appletoptions,
        stripped_answer_id) {
    ...
    show_java: function(id, appletid, appletname, java, width, height,
        appletclass, javavars, stripped_answer_id) {
        if (this.javainstalled == -99) {
            this.javainstalled = PluginDetect.isMinVersion('Java', 1.5,
                'plugindetect.getjavainfo.jar', [0, 2, 0]) == 1;
        }
